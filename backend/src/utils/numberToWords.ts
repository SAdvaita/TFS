...
/**
 * Converts a numerical amount (INR) into standard uppercase English words following Indian numbering system.
 * e.g., 900 -> "NINE HUNDRED ONLY"
 * 1800 -> "ONE THOUSAND EIGHT HUNDRED ONLY"
 * 105000 -> "ONE LAKH FIVE THOUSAND ONLY"
 */
